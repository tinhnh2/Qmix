...
def main():
    ...
    while exit_loop == 0:
        ...
        # os.system(cmd)
        corr1 = pearon_corr("loop%d/step5/Q.step3.4x.1" %
                            loop_id, "loop%d/step5/Q.step5.4x.1" % loop_id)
        corr2 = pearon_corr("loop%d/step5/Q.step3.4x.2" %
                            loop_id, "loop%d/step5/Q.step5.4x.2" % loop_id)
        corr3 = pearon_corr("loop%d/step5/Q.step3.4x.3" %
                            loop_id, "loop%d/step5/Q.step5.4x.3" % loop_id)
        corr4 = pearon_corr("loop%d/step5/Q.step3.4x.4" %
                            loop_id, "loop%d/step5/Q.step5.4x.4" % loop_id)
